    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="thumbnail thumbnail-caption thumbnail-bordered">
          ...
          <div class="caption">
            <h4>Drupal</h4>
            <p>I have extensive Drupal experience from my time at Klarna. Their needs for a scalable and multilingual platform led us to migrate their main website from Joomla and rebuild it entirely in Drupal.</p>
          </div>
        </div>
      </div>
